...
contract CarChain {
    ...
    event addRenterEvent(address indexed wallet, string memory firstName, string memory lastName, bool canRent, bool active, uint balance, uint due, uint start, uint end );
    ...
    function addRenter(address payable walletAddress, string memory firstName, string memory lastName, bool canRent, bool active, uint balance, uint due, uint start, uint end) public {
        ...
        emit addRenterEvent(walletAddress, firstName, lastName, canRent, active, balance, due,  start, end)
    }
